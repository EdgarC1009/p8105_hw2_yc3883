...
Resulting dataset combined three above datasets together. The dimension of "union3_df" is `r dim(union3_df)` indicating rows and columns respectively. The range of years is [`r range(pull(union3_df, year))`]. Key variables are `r names(union3_df)`.
